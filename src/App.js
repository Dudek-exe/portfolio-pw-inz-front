...
import {CarCreate, CarEdit, CarList} from './components/cars';
...
const App = () => (
    <Admin dataProvider={dataProvider} authProvider={authProvider}>
        ...
        <Resource name="car" list={CarList} create={CarCreate} edit={CarEdit} options={{label: 'Samochody'}} icon={DriveEtaIcon}/>
